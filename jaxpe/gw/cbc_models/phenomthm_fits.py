...
def IMRPhenomT_PeakFrequency_22(eta, S, dchi, delta):
    return (
        0.27212130745330404
...
def IMRPhenomT_RD_Freq_D2_22(eta, S, dchi, delta):
    return (
        0.1598180460429256
...
def IMRPhenomT_RD_Freq_D3_22(eta, S, dchi, delta):
    return (
        2.6456463496860927
...
def IMRPhenomT_Merger_Amp_CP1_22(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_PeakAmp_22(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_RD_Amp_C3_22(eta, S):
    return (
        -0.48053994718185694
...
def IMRPhenomT_Merger_Freq_CP1_21(eta, S, dchi, delta):
    return (
        0.10101116560411222
...
def IMRPhenomT_Merger_Freq_CP1_33(eta, S, dchi, delta):
    return (
        0.28925318007299916
...
def IMRPhenomT_Merger_Freq_CP1_44(eta, S, dchi, delta):
    return (
        0.3839588385106795
...
def IMRPhenomT_Merger_Freq_CP1_55(eta, S, dchi, delta):
    return (
        0.49157926097800314
...
def IMRPhenomT_PeakFrequency_21(eta, S, dchi, delta):
    return (
        0.17642087831932626
...
def IMRPhenomT_PeakFrequency_33(eta, S, dchi):
    return (
        0.42535721148121036
...
def IMRPhenomT_PeakFrequency_44(eta, S, dchi, delta):
    return (
        0.5640094664638
...
def IMRPhenomT_PeakFrequency_55(eta, S, dchi, delta):
    return (
        0.7146297908371999
...
def IMRPhenomT_RD_Freq_D2_21(eta, S, dchi, delta):
    return (
        0.1781545202005886
...
def IMRPhenomT_RD_Freq_D3_21(eta, S, dchi, delta):
    return (
        3.757258772469613
...
def IMRPhenomT_RD_Freq_D2_33(eta, S, dchi, delta):
    return (
        0.16417885317959574
...
def IMRPhenomT_RD_Freq_D3_33(eta, S, dchi, delta):
    return (
        2.0503935647397173
...
def IMRPhenomT_RD_Freq_D2_44(eta, S, dchi, delta):
    return (
        0.21336620664104916
...
def IMRPhenomT_RD_Freq_D3_44(eta, S, dchi, delta):
    return (
        3.824722911046124
...
def IMRPhenomT_RD_Freq_D2_55(eta, S, dchi, delta):
    return (
        0.2143703929690296
...
def IMRPhenomT_RD_Freq_D3_55(eta, S, dchi, delta):
    return (
        3.421296704767661
...
def IMRPhenomT_Inspiral_Amp_CP1_21(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Inspiral_Amp_CP2_21(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Inspiral_Amp_CP3_21(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Merger_Amp_CP1_21(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_PeakAmp_21(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_RD_Amp_C3_21(eta, S, dchi):
    return (
        -0.04334302376511826
...
def IMRPhenomT_Inspiral_Amp_CP1_33(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Inspiral_Amp_CP2_33(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Inspiral_Amp_CP3_33(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Merger_Amp_CP1_33(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_PeakAmp_33(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_RD_Amp_C3_33(eta, S):
    return (
        -0.28666660414434536
...
def IMRPhenomT_Inspiral_Amp_CP1_44(eta, S, dchi, delta):
    return (
        S
        * (
...
def IMRPhenomT_Inspiral_Amp_CP2_44(eta, S, dchi, delta):
    return (
        S
        * (
...
def IMRPhenomT_Inspiral_Amp_CP3_44(eta, S, dchi, delta):
    return (
        S
        * (
...
def IMRPhenomT_Merger_Amp_CP1_44(eta, S, dchi, delta):
    return (
        S
        * (
...
def IMRPhenomT_PeakAmp_44(eta, S, dchi, delta):
    return (
        0.697452842995687
        * dchi
        * delta
...
def IMRPhenomT_RD_Amp_C3_44(eta, S):
    return (
        -0.1772709159577312
...
def IMRPhenomT_Inspiral_Amp_CP1_55(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Inspiral_Amp_CP2_55(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Inspiral_Amp_CP3_55(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_Merger_Amp_CP1_55(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_PeakAmp_55(eta, S, dchi, delta):
    return (
...
def IMRPhenomT_RD_Amp_C3_55(eta, S, dchi):
    return (
        0.01889156394866289
...
def IMRPhenomT_tshift_21(eta, S, dchi):
    return (
        11.67621653653603
...
def IMRPhenomT_tshift_33(eta, S):
    return (
        6.047225180659371
...
def IMRPhenomT_tshift_44(eta, S):
    return (
        S
        * (
            -5.203270014829841
...
def IMRPhenomT_tshift_55(eta, S):
    return (
        -0.3189869259194407
...
# ---------------------------------------------------------------------------------------
# (2,2) inspiral-frequency collocation points + TaylorT3 t0, and the (2,2) merger-frequency
# collocation point -- absent from the original transcription above (which covered peak
# freq/amp, RD shape coefficients, and amplitude collocation points for all 5 modes, but not
# these (2,2) *frequency* pieces). Needed by IMRPhenomTSetPhase22Coefficients's inspiral 6x6
# and merger 3x3 coefficient solves (see jaxpe/gw/cbc_models/phenomt.py). Mechanically
# extracted from lalsimulation/lib/LALSimIMRPhenomTHM_fits.c (pow(...) -> jnp.power(...),
# no other changes) to avoid hand-transcription errors in these long polynomials.
# ---------------------------------------------------------------------------------------


def IMRPhenomT_Inspiral_TaylorT3_t0(eta, S, dchi, delta):
    return jnp.power(eta, -1) * (
...
def IMRPhenomT_Inspiral_Freq_CP1_22(eta, S, dchi, delta):  # theta = 0.45
    return (
...
def IMRPhenomT_Inspiral_Freq_CP2_22(eta, S, dchi, delta):  # theta = 0.55
    return (
        -0.04486391236129559
        * dchi
        * delta
...
def IMRPhenomT_Inspiral_Freq_CP3_22(eta, S, dchi, delta):  # theta = 0.65
    return (
        -0.10196878573773932
        * dchi
        * delta
...
def IMRPhenomT_Inspiral_Freq_CP4_22(eta, S, dchi, delta):  # theta = 0.75
    return (
        -0.1831889759662071
        * dchi
        * delta
...
def IMRPhenomT_Inspiral_Freq_CP5_22(eta, S, dchi, delta):  # theta = 0.82
    return (
        -0.2508206617297265
        * dchi
        * delta
...
def IMRPhenomT_Merger_Freq_CP1_22(eta, S, dchi, delta):  # theta = 0.95
    return (
        -0.3926039690467202
        * dchi
        * delta
...
# ---------------------------------------------------------------------------------------
# QNM ringdown/damping frequency of the final BH for the (2,2) mode, and the PhenomX final
# mass/spin fits (Jimenez-Forteza et al 2017, arXiv:1611.00332) IMRPhenomTHM itself uses for
# the remnant (XLALSimIMRPhenomXFinalMass2017/FinalSpin2017 -- a different fit family from
# this repo's own EradRational0815/FinalSpin0815 in phenomd.py, which IMRPhenomD uses
# instead). ``S`` here is the same mass-weighted total-spin combination already computed
# throughout this file (XLALSimIMRPhenomXSTotR uses an identical formula).
# ---------------------------------------------------------------------------------------
...
def IMRPhenomX_FinalMass2017(eta, S, dchi, delta):
    """1 - E_radiated. Jimenez-Forteza et al, PRD 95, 064024 (2017), arXiv:1611.00332."""
...
def IMRPhenomX_FinalSpin2017(eta, S, dchi, delta):
    """Jimenez-Forteza et al, PRD 95, 064024 (2017), arXiv:1611.00332."""
    m1 = 0.5 * (1.0 + delta)
    m2 = 0.5 * (1.0 - delta)
    m1sq, m2sq = m1 * m1, m2 * m2
    eta2, eta3 = jnp.power(eta, 2), jnp.power(eta, 3)
    S2, S3 = jnp.power(S, 2), jnp.power(S, 3)
    dchi2 = jnp.power(dchi, 2)
...
def evaluate_QNMfit_fdamp22n2(a):
    ...
    Needed by the ringdown amplitude ansatz's c2 coefficient (0.5*(alpha2RD - alpha1RD),
    Damour&Nagar 2014 eq. 7 / PhenomTHM paper eq. 26d) -- distinct from the n=1
    evaluate_QNMfit_fdamp22 used for the frequency/phase ansatz.
    """
...
# ---------------------------------------------------------------------------------------
# QNM ringdown/damping frequency fits for the (2,1),(3,3),(4,4),(5,5) modes (n=1 and n=2
# overtones), needed by IMRPhenomTHM's higher-mode frequency/phase and ringdown-amplitude
# ansätze (jaxpe/gw/cbc_models/phenomthm.py). Mechanically extracted from
# LALSimIMRPhenomTHM_fits.c, matching evaluate_QNMfit_fring22/fdamp22/fdamp22n2 above.
# ---------------------------------------------------------------------------------------
