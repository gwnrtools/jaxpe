...
# ==============================================================================
    ...
    print(f"Local (MALA) Acceptance rates per loop: {[f'{a:.2f}' for a in results.local_acceptance]}")
    print(f"Global (Flow) Acceptance rates per loop: {[f'{a:.2f}' for a in results.global_acceptance]}")
