...
Because our flow density $$q_\phi$$ is a highly accurate map of the true posterior $$\pi$$, the ratio $$\pi/q_\phi$$ approaches unity. Our explorers can now instantly teleport between isolated degenerate modes with exceptionally high success rates.
