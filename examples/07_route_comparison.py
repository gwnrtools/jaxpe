...
Examples
--------
    JAX_PLATFORMS=cpu python examples/07_route_comparison.py            # both methods
    JAX_PLATFORMS=cpu python examples/07_route_comparison.py --method surrogate
    python examples/07_route_comparison.py --check-ode-grid             # grid study only
