...
def optimize_fits(filepath):
    ...
    functions = re.findall(r'def ([A-Za-z0-9_]+)\((.*?)\):\n    return (.*?)\n\n', content, re.DOTALL)
    ...
    out += "    This leverages XLA's Common Subexpression Elimination (CSE) to massively\n"
    ...
    with open("/home/prayush/src/jaxpe/jaxpe/gw/cbc_models/phenomthm_fits_optimized.py", 'w') as f:
        f.write(out)
